  ...
  this.skf_drawGrid(10*this.overSampling,10*this.overSampling,this.initWidth-hud_width,this.initHeight-10*this.overSampling);
  ...
  for(var i=1;i<6;++i) {
    ...
    ctx.arc(minX, y, 3*this.overSampling, 0, 2 * Math.PI, false);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(maxX, y, 3*this.overSampling, 0, 2 * Math.PI, false);
  }
  ctx.fill();
